 ...
 */
public class ValidateSettlementOfFirstOrderTest extends BaseTest {
	...
	public void test() {
		...
		try {
			componentHelper.execute(ValidateSettlementOfFirstOrder.wrapParams(settlementInfo, marketItemDTOs, userId, appKey));
