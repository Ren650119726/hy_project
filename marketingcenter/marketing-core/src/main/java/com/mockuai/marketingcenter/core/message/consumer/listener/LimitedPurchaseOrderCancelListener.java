...
/**
 * Created by huangsiqian on 2016/11/14.
 */
@Component
public class LimitedPurchaseOrderCancelListener extends BaseListener {
    private static final Logger LOGGER = LoggerFactory.getLogger(LimitedPurchaseOrderCancelListener.class);
    @Resource
    ...
    public void consumeMessage(JSONObject msg, String appKey) throws MarketingException {
        ...
        LOGGER.info("tradeOrderCancelMSG:{}", JsonUtil.toJson(orderDTO));
        ...
        LOGGER.info("tradeOrderCancelInfo:{}",JsonUtil.toJson(paylist));
