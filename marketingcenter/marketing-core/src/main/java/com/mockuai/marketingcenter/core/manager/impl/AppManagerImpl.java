...
public class AppManagerImpl implements AppManager {
    ...
    public BizInfoDTO getBizInfo(String bizCode) throws MarketingException {
        ...
        if (StringUtils.isBlank(bizCode)) {
            throw new MarketingException(ResponseCode.PARAMETER_NULL.getCode(), "bizCode is null");
        }
    ...
    public AppInfoDTO getAppInfo(String appKey) throws MarketingException {
        ...
        if (StringUtils.isBlank(appKey)) {
            throw new MarketingException(ResponseCode.PARAMETER_NULL.getCode(), "appKey is null");
        }
    ...
    @Override
    public String getAppKeyByBizCode(String bizCode) throws MarketingException {
        if (StringUtils.isBlank(bizCode)) {
