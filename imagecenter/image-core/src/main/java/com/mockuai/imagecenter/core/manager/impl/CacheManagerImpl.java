...
public class CacheManagerImpl implements CacheManager {
   ...
   /* private final String host = "558c1e51d6e640c5.m.cnhzaliqshpub001.ocs.aliyuncs.com";//控制台上的“内网地址”
    ...
    public  CacheManagerImpl(String host,int port,String username,String password){
    ...
    public static void main(String[] args) {
        ...
        final String host = "558c1e51d6e640c5.m.cnhzaliqshpub001.ocs.aliyuncs.com";//控制台上的“内网地址”
        final String port ="11211"; //默认端口 11211，不用改
        final String username = "558c1e51d6e640c5";//控制台上的“访问账号”
        final String password = "hzkansQWSD123";//邮件中提供的“密码”
