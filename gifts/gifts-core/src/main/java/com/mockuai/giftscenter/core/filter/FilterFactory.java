...
public class FilterFactory {
	...
	public static Filter createFilter(FilterDescBean bean) throws GiftsException {
	...
	private static void setField(Object instance, Field fd, String value) throws GiftsException {
		try {
