...
public class AppManagerImpl implements AppManager {
    ...
    public BizInfoDTO getBizInfo(String bizCode) throws GiftsException {
        ...
        if (StringUtils.isBlank(bizCode)) {
            throw new GiftsException(ResponseCode.PARAMETER_NULL.getCode(), "bizCode is null");
        }
    ...
    public AppInfoDTO getAppInfo(String appKey) throws GiftsException {
        ...
        if (StringUtils.isBlank(appKey)) {
            throw new GiftsException(ResponseCode.PARAMETER_NULL.getCode(), "appKey is null");
        }
    ...
    @Override
    public String getAppKeyByBizCode(String bizCode) throws GiftsException {
        if (StringUtils.isBlank(bizCode)) {
            throw new GiftsException(ResponseCode.PARAMETER_NULL, "bizCode is null");
        }
        try {
