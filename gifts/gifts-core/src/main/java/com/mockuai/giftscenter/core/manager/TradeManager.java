...
public interface TradeManager {
     ...
     * @param appKey
     */
    void addPreOrder(OrderDTO orderDTO, String appKey) throws GiftsException;
     ...
     */
    boolean queryPreOrder(OrderQTO orderQTO, String appKey) throws GiftsException;
     ...
     * @return
     */
    Long querySalesRatio(DataQTO dataQTO, String appKey) throws GiftsException;
     ...
     * @return
     */
    List<ItemSalesVolumeDTO> queryItemSalesVolume(DataQTO dataQTO, String appKey) throws GiftsException;
     ...
     * @return
     */
    DataDTO getData(DataQTO dataQTO, String appKey) throws GiftsException;
}