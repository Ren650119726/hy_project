 ...
 */
@Service
public class DeleteGiftsAction extends TransAction {
    ...
    protected GiftsResponse doTransaction(RequestContext context) throws GiftsException {
    	...
    	Integer asd = giftsPacketManager.deleteGiftsPacket(giftsPacketDTO,appKey);
    ...
    public String getName() {
        return ActionEnum.DELETE_GIFTS.getActionName();
    }
}