 ...
 */
public class GiftsPacketDTO implements Serializable {
    ...
    private String levelMoneyScore;
    private List<GiftsPacketProfitDTO> profitList;
	...
	public String getLevelMoneyScore() {
		return levelMoneyScore;
	}
	public void setLevelMoneyScore(String levelMoneyScore) {
		this.levelMoneyScore = levelMoneyScore;
	}
	public List<GiftsPacketProfitDTO> getProfitList() {
		return profitList;
	}
	public void setProfitList(List<GiftsPacketProfitDTO> profitList) {
