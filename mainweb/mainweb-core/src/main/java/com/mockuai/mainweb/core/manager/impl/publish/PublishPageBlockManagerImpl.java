...
import com.mockuai.mainweb.core.manager.publish.PublishPageBlockManager;
 ...
 */
@Service
public class PublishPageBlockManagerImpl implements PublishPageBlockManager {
    @Resource
    private PublishPageBlockDAO pageBlockDAO;
