 ...
 */
@Controller
public class UpdateSysFieldMapByVauleAction implements Action {
    @Resource
    ...
    public RainbowResponse execute(RequestContext context) {
        ...
        Integer result;
        try {
            result = this.sysFieldMapManager.updateSysFieldMapByValue(sysFieldMapDTO);
    ...
    public String getName() {
        return ActionEnum.UPDATE_SYSFIELDMAP_BY_VALUE.getActionName();
    }
}
