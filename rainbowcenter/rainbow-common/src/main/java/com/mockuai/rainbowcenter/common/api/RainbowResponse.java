package com.mockuai.rainbowcenter.common.api;
...
public class RainbowResponse<T> implements Response<T>,Serializable{
	...
	public RainbowResponse(ResponseCode responseCode) {
		this.code = responseCode.getValue();
		this.message = responseCode.getDesc();
	}

	public RainbowResponse(ResponseCode responseCode, String message) {
		this.code = responseCode.getValue();
	...
	public RainbowResponse(T module) {
		this.module = module;
		if (module != null) {
	...
	public RainbowResponse(T module, Long totalCount) {
		this.module = module;
		this.code = ResponseCode.REQUEST_SUCCESS.getValue();
		this.message = ResponseCode.REQUEST_SUCCESS.getDesc();
