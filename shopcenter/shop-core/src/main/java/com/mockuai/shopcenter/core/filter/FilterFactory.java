...
public class FilterFactory {
	...
	public static Filter createFilter(FilterDescBean bean) throws ShopException {
	...
	private static void setField(Object instance, Field fd, String value) throws ShopException {
		try {
