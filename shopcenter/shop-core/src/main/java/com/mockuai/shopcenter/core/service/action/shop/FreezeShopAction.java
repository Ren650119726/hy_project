 ...
 */
@Service
public class FreezeShopAction implements Action {
    ...
    public ShopResponse execute(RequestContext context) throws ShopException {
        ...
        try {
            Boolean result = shopManager.updateShopStatus(sellerId, ShopStatusEnum.TEMP_FREEZEN.getStatus());
            if(result) {
    ...
    public String getName() {
        return ActionEnum.FREEZE_SHOP.getActionName();
    }
}
