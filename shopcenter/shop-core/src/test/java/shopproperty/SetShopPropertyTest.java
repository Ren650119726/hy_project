...
public class SetShopPropertyTest {
    ...
    public void test01(){
        ...
        shopRequest.setParam("value","ppxx");
        shopRequest.setParam("sellerId", SELLER_ID);
        shopRequest.setParam("appKey",APP_KEY);

        shopRequest.setCommand(ActionEnum.SET_SHOP_PROPERTY.getActionName());
