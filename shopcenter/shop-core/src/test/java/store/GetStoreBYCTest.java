...
public class GetStoreBYCTest {
    ...
    public void test01(){
        ...
        shopRequest.setParam("id",2L);
        shopRequest.setParam("longitude","120");
        shopRequest.setParam("latitude","30");
        shopRequest.setParam("sellerId",38706);
