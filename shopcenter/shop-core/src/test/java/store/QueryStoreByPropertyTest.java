...
public class QueryStoreByPropertyTest {
    ...
    public void test01(){
        ...
        shopRequest.setCommand(ActionEnum.QUERY_STORE_IDS_BY_PROPERTY.getActionName());

        Response<List<Long>> response = shopService.execute(shopRequest);
