 ...
 */
public class GetStoreRecoveryConfig extends BaseAction{
    ...
    public MopResponse execute(Request request) {
        ...
        final String key1 = PropertyConsts.RECOVERY_RECEIVER;
        final String key2 = PropertyConsts.RECOVERY_MOBILE;
        final String key3 = PropertyConsts.RECOVERY_ADDRESS;
    ...
    public String getName() {
        return "/store/config/recovery/get";
    }
