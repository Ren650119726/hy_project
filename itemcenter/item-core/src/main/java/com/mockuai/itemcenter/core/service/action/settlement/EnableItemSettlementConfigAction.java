 ...
 */
@Service
public class EnableItemSettlementConfigAction extends TransAction{
    ...
    protected ItemResponse doTransaction(RequestContext context) throws ItemException {
        ...
        Long result = itemSettlementConfigManager.enableItemSettlementConfig(id,bizCode);
    ...
    public String getName() {
        return ActionEnum.ENABLE_ITEM_SETTLEMENT_CONFIG.getActionName();
    }
}
