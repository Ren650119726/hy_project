 ...
 */
@Service
public class ThawItemAction extends TransAction {
    ...
    public ItemResponse doTransaction(RequestContext context) throws ItemException {
        try {
            ...
            int result = itemManager.thawItem(itemId, sellerId, bizCode);
            if(result > 0){
    ...
    public String getName() {
        return ActionEnum.THAW_ITEM_ACTION.getActionName();
    }
}
