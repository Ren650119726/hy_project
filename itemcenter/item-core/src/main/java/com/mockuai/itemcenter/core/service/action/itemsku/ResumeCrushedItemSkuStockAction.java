...
@Service
public class ResumeCrushedItemSkuStockAction implements Action {
	private static final Logger log = LoggerFactory.getLogger(ResumeCrushedItemSkuStockAction.class);
	@Resource
	...
	public ItemResponse execute(RequestContext context) throws ItemException {
        ...
        try {
            itemSkuManager.resumeCrushedItemSkuStock(skuId, sellerId, increasedNumber, bizCode);
	...
	public String getName() {
		return ActionEnum.RESUME_CRUSHED_ITEM_SKU_STOCK.getActionName();
	}
}
