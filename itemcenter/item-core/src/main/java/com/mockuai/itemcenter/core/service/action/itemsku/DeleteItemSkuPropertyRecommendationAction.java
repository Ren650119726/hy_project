 ...
 */
@Service
public class DeleteItemSkuPropertyRecommendationAction extends TransAction {
    ...
    protected ItemResponse doTransaction(RequestContext context) throws ItemException {
        ...
        Long result = itemSkuPropertyRecommendationManager.deleteItemSkuPropertyRecommendation(id, sellerId, bizCode);
    ...
    public String getName() {
        return ActionEnum.DELETE_ITEM_SKU_PROPERTY_RECOMMENDATION.getActionName();
    }
}
