...
@Service
public class FreezeItemSkuStockAction implements Action {
	private static final Logger log = LoggerFactory.getLogger(FreezeItemSkuStockAction.class);
	@Resource
	...
	public ItemResponse execute(RequestContext context) throws ItemException {
		...
		if (request.getInteger("number") == null) {
			return ResponseUtil.getErrorResponse(ResponseCode.PARAM_E_MISSING, "freezeNumber is missing");
		}
        ...
        try {
            itemSkuManager.freezeItemSkuStock(skuId, sellerId, increasedNumber, bizCode);
	...
	public String getName() {
		return ActionEnum.FREEZE_ITEM_SKU_STOCK.getActionName();
	}
}
