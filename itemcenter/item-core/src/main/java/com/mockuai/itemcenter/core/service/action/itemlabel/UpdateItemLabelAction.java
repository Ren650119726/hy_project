 ...
 */
@Service
public class UpdateItemLabelAction extends TransAction{
    ...
    protected ItemResponse doTransaction(RequestContext context) throws ItemException {
        ...
        Long result = itemLabelManager.updateItemLabel(itemLabelDTO);
    ...
    public String getName() {
        return ActionEnum.UPDATE_ITEM_LABEL.getActionName();
    }
}
