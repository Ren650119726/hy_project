...
@Service
public class DeleteItemDescTemplateAction extends TransAction {

    private static final Logger log = LoggerFactory.getLogger(DeleteItemDescTemplateAction.class);
    ...
    protected ItemResponse doTransaction(RequestContext context) throws ItemException {
        ...
        Long result = itemDescTmplManager.deleteItemDescTmpl(itemDescTmplId, sellerId, bizCode);
    ...
    public String getName() {
        return ActionEnum.DELETE_ITEM_DESC_TMPL.getActionName();
    }
}
