 ...
 */
@Service
public class UpdateFreightTemplateAction extends TransAction{
    ...
    protected ItemResponse doTransaction(RequestContext context) throws ItemException {
        ...
        Boolean result = freightTemplateManager.updateFeightTemplate(freightTemplateDTO);
    ...
    public String getName() {
        return ActionEnum.UPDATE_FREIGHT_TEMPLATE_ACTION.getActionName();
    }
}
