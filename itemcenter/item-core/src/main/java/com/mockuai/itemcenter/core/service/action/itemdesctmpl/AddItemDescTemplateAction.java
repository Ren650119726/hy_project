...
@Service
public class AddItemDescTemplateAction extends TransAction {

    private static final Logger log = LoggerFactory.getLogger(AddItemDescTemplateAction.class);
    ...
    protected ItemResponse doTransaction(RequestContext context) throws ItemException {
        ...
        Long id = itemDescTmplManager.addItemDescTmpl(itemDescTmplDTO);
    ...
    public String getName() {
        return ActionEnum.ADD_ITEM_DESC_TMPL.getActionName();
    }
}
