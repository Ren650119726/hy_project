		...
		ItemResponse response = (ItemResponse)transactionTemplate.execute(new TransactionCallback() {
			...
			public Object doInTransaction(TransactionStatus status) {
				try {
                    ...
                    // 获取skuId
                    SkuPropertyDTO skuPropertyDTO = skuPropertyManager.getSkuProperty(skuPropertyId, sellerId, bizCode);
                    Long skuId = skuPropertyDTO.getSkuId();

                    skuPropertyManager.deleteSkuProperty(skuPropertyId, sellerId, bizCode);
