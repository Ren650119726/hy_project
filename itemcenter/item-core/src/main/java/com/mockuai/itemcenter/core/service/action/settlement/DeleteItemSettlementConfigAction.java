 ...
 */
@Service
public class DeleteItemSettlementConfigAction extends TransAction{
    ...
    protected ItemResponse doTransaction(RequestContext context) throws ItemException {
        ...
        Long result = itemSettlementConfigManager.deleteItemSettlementConfig(id,bizCode);
    ...
    public String getName() {
        return ActionEnum.DELETE_ITEM_SETTLEMENT_CONFIG.getActionName();
    }
}
