 ...
 */
@Service
public class BatchTrashItemAction extends TransAction {
    private static final Logger log = LoggerFactory.getLogger(BatchTrashItemAction.class);
    @Resource
    ...
    public ItemResponse doTransaction(final RequestContext context) throws ItemException {
        ...
        response = ResponseUtil.getSuccessResponse(1L);
        return response;
    }

    @Override
    public String getName() {
        return ActionEnum.BATCH_TRASH_ITEM.getActionName();
    }
}
