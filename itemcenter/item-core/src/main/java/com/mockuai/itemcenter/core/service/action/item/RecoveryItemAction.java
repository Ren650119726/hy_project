 ...
 */
@Service
public class RecoveryItemAction extends TransAction {
    private static final Logger log = LoggerFactory.getLogger(RecoveryItemAction.class);
    @Resource
    ...
    public String getName() {
        return ActionEnum.RECOVERY_ITEM.getActionName();
    }
}
