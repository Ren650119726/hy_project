 ...
 */
@Service
public class CopyFreightTemplateAction extends TransAction{
    ...
    protected ItemResponse doTransaction(RequestContext context) throws ItemException {
        ...
        if(freightTemplateDTO==null){
            return ResponseUtil.getErrorResponse(ResponseCode.PARAM_E_MISSING,"查询的运费模板不存在");
        }
    ...
    public String getName() {
        return ActionEnum.COPY_FREIGHT_TEMPLATE_ACTION.getActionName();
    }
}
