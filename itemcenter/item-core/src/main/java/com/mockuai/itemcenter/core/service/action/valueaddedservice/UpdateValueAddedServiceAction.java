 ...
 */
@Service
public class UpdateValueAddedServiceAction extends TransAction{
    ...
    protected ItemResponse doTransaction(RequestContext context) throws ItemException {
        ...
        Long result = valueAddedServiceManager.updateValueAddedService(serviceDTO);
    ...
    public String getName() {
        return ActionEnum.UPDATE_VALUE_ADDED_SERVICE.getActionName();
    }
}
