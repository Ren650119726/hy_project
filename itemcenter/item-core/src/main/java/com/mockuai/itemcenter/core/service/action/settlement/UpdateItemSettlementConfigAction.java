 ...
 */
@Service
public class UpdateItemSettlementConfigAction extends TransAction{
    ...
    protected ItemResponse doTransaction(RequestContext context) throws ItemException {
        ...
        Long result = itemSettlementConfigManager.updateItemSettlementConfig(itemSettlementConfigDTO, appKey);
    ...
    public String getName() {
        return ActionEnum.UPDATE_ITEM_SETTLEMENT_CONFIG.getActionName();
    }
}
