...
public class GetItemSkuTest {
	...
	public void test001() {
		...
		request.setParam("ID", 928L);
		request.setParam("sellerId", 38699L);
		//request.setParam("appKey",);
	 ...
	 */
	public void test004() {
        Request request = RequestFactory.newRequest(AppKeyEnum.MOCKUAI_DEMO, ActionEnum.QUERY_ITEM_SKU);
        ItemSkuQTO itemSkuQTO = new ItemSkuQTO();
        itemSkuQTO.setId(3357L);
