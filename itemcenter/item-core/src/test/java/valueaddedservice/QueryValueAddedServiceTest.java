...
public class QueryValueAddedServiceTest {
    ...
    public void test01() {
        ...
        ValueAddedServiceTypeQTO serviceTypeQTO = new ValueAddedServiceTypeQTO();
        serviceTypeQTO.setPageSize(1);
        serviceTypeQTO.setCurrentPage(1);
        serviceTypeQTO.setNeedPaging(true);
        serviceTypeQTO.setSellerId(SELLER_ID);

        request.setParam("valueAddedServiceTypeQTO",serviceTypeQTO);
