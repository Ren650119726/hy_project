...
public class FreightTemplateDTO implements FreightTemplate,Serializable {
    ...
    private List<FreightAreaTemplateDTO> freightAreaTemplateList;

    public List<FreightAreaTemplateDTO> getFreightAreaTemplateList() {
        return freightAreaTemplateList;
    }

    public void setFreightAreaTemplateList(List<FreightAreaTemplateDTO> freightAreaTemplateList) {
        this.freightAreaTemplateList = freightAreaTemplateList;
    }
