...
public class QueryUserOneselfInfoAction extends BaseAction {
	...
	public MopResponse execute(Request request) {
        ...
        userReq.setCommand(ActionEnum.QUERY_USERONESELFINFO.getActionName());
    ...
    public String getName() {
        return "/user/userOneselfInfo/query";
    }
