...
public class SupplierCartItemList extends BaseAction {
	...
	private List<MopSupplierCartDTO> genMopCartItemList(List<SupplierCartDTO> supplierCartDTOs) {
		...
		for (SupplierCartDTO supplierCart : supplierCartDTOs) {
			MopSupplierCartDTO mopSupplierCartDTO = new MopSupplierCartDTO();
			mopSupplierCartDTO.setSupplierId(supplierCart.getSupplierId());
			mopSupplierCartDTO.setSupplierName(supplierCart.getSupplierName());

			List mopCartItemDTOs = new ArrayList();
			for (CartItemDTO cartItemDTO : supplierCart.getCartItems()) {
				mopCartItemDTOs.add(genMopCartItem(cartItemDTO));
			}

			mopSupplierCartDTO.setItemList(mopCartItemDTOs);

			mopSupplierCartDTO.setDiscountInfoList(supplierCart.getDiscountInfoList());
	...
	public String getName() {
		return "/trade/supplier/cart/item/list"; // 供应商购物车列表
	}
