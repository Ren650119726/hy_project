...
public class MoneyUtil {
	...
	public static String getMoneyStr(Long cent,String format) {
		Money money = new Money();
		money.setCent(cent);

		return getFormatMoney(money.toString(), format);
	...
	public static String getFormatMoneyCategory(Double money) {
		...
		String[] array=StringUtil.split(formatMoney, ".");
...
//		System.out.println(getMoneyStr(12900L));
		System.out.println(div("1111"
				+ "","2000"));
		
//		System.out.println(getFormatMoney(mul(100d,mul("1","1.00"
//				+ "")),"##0"));
