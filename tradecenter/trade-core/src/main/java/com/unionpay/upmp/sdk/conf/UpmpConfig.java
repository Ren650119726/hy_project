...
//			SECURITY_KEY = props.getString(KEY_SECURITY_KEY);
			VERSION="1.0.0";
			CHARSET="UTF-8";
			MER_ID="898111448161343";
//			MER_ID="777290058116249";
			SECURITY_KEY="3nJ0bFaytXawLsbngP9CT4ZhRKDN8DSi";
			SIGN_TYPE="MD5";
			MER_FRONT_END_URL="";
			MER_BACK_END_URL="http://api.mockuai.com/trade/order/payment/callback/unionpay_notify";
