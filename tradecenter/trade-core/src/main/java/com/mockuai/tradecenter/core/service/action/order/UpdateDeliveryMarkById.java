 ...
 * @author LY
 */
public class UpdateDeliveryMarkById implements Action{
	private static final Logger log = LoggerFactory.getLogger(UpdateDeliveryMarkById.class);
	...
	public TradeResponse<Boolean> execute(RequestContext context) throws TradeException {
		...
		try{
			...
			if(this.orderManager.updateDeliveryMarkById(orderQTO)){
	...
	public String getName() {
		return ActionEnum.UPDATE_DELIVERY_MARK.getActionName();
	}
}
