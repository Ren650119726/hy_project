 ...
 */
@Service
public class UpdateOrderSupplier implements Action{
	private static final Logger log = LoggerFactory.getLogger(UpdateOrderSupplier.class);
	...
	public TradeResponse<Boolean> execute(RequestContext context) throws TradeException {
		...
		try{
			...
			if(this.orderManager.UpdateOrderSupplier(orderQTO)){
	...
	public String getName() {
		return ActionEnum.UPDATE_ORDER_SUPPLIER.getActionName();
	}
}
