...
public final class VirtualWealthUtils{
    ...
    public static <T> VirtualWealthResponse<T> getSuccessResponse() {
        return new VirtualWealthResponse(ResponseCode.SUCCESS);
    }


    public static <T> VirtualWealthResponse<T> getSuccessResponse(T module, int total) {

        VirtualWealthResponse response = new VirtualWealthResponse(module, total);
    ...
    public static <T> VirtualWealthResponse<T> getSuccessResponse(T module) {
    ...
    public static <T> VirtualWealthResponse<T> getFailResponse(int errorCode, String msg) {

        return new VirtualWealthResponse(errorCode, msg);
