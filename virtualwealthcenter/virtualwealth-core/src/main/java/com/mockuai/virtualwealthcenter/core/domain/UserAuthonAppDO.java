...
public class UserAuthonAppDO {

public UserAuthonAppDO(){
...
public String toString() {
	return "UserAuthonAppDO [id=" + id + ", userId=" + userId + ", bizCode="
			+ bizCode + ", authonPersonalid=" + authonPersonalid
			+ ", authonNo=" + authonNo + ", authonMobile=" + authonMobile
			+ ", authonRealname=" + authonRealname + ", authonText="
			+ authonText + ", authonStatus=" + authonStatus + ", authonTime="
			+ authonTime + ", deleteMark=" + deleteMark + ", gmtCreated="
			+ gmtCreated + ", gmtModified=" + gmtModified + ", authonBankname="
			+ authonBankname + ", pictureFront=" + pictureFront
