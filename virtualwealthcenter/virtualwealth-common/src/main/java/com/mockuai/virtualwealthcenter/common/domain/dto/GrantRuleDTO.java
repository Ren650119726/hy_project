 ...
 */
public class GrantRuleDTO implements Serializable {
    private Long id;
    ...
    /**
     * {@link com.mockuai.virtualwealthcenter.common.constant.SourceType}
     */
    ...
    private List<RuleModuleDTO> ruleModuleDTOs;
    ...
    public List<RuleModuleDTO> getRuleModuleDTOs() {
        return ruleModuleDTOs;
    }

    public void setRuleModuleDTOs(List<RuleModuleDTO> ruleModuleDTOs) {
        this.ruleModuleDTOs = ruleModuleDTOs;
    }
}