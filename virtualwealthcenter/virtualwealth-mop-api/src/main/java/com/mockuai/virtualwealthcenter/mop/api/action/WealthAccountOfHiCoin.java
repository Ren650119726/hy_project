...
import static com.mockuai.virtualwealthcenter.common.constant.ActionEnum.GET_HI_COIN;

/**
 * Created by edgar.zr on 5/13/2016.
 */
public class WealthAccountOfHiCoin extends BaseAction {
    ...
    public MopResponse execute(com.mockuai.mop.common.service.action.Request request) {
        ...
        marketReq.setCommand(GET_HI_COIN.getActionName());
    ...
    public String getName() {
        return "/marketing/wealth_account/coin";
    }
