package com.mockuai.appcenter.common.api;
...
public class AppResponse<T> implements Response<T>,Serializable{
    ...
    public AppResponse(ResponseCode responseCode, String message){
    	this.code = responseCode.getCode();
    	this.message = message;
    }

    public AppResponse(ResponseCode responseCode){
    	this.code = responseCode.getCode();
