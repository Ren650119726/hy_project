...
public class CacheManagerImpl implements CacheManager {
    ...
    public void set(String key, int expired, Object obj){
        ...
        try{
            ...
            log.error("error to set cache, key:{}", key, t);
        }
    }
    ...
    public Object get(String key){
        ...
        try{
            ...
            log.error("error to get cache, key:{}", key, t);
        }
    ...
    public Object getAndTouch(String key, int expired) {
        ...
        try{
            ...
            log.error("error to getAndTouch cache, key:{}", key, t);
        }
    ...
    public void delete(String key) {
        ...
        try{
            ...
            log.error("error to delete cache, key:{}", key, t);
        }
    }
