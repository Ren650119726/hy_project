...
public class FilterFactory {
	...
	public static Filter createFilter(FilterDescBean bean) throws AppException {
	...
	private static void setField(Object instance, Field fd, String value) throws AppException {
		try {
