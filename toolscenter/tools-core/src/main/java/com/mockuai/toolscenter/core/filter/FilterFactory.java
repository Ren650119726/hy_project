...
public class FilterFactory {
	...
	public static Filter createFilter(FilterDescBean bean) throws ToolsException {
	...
	private static void setField(Object instance, Field fd, String value) throws ToolsException {
		try {
