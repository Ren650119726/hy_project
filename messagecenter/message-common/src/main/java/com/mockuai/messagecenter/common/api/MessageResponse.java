package com.mockuai.messagecenter.common.api;
...
public class MessageResponse<T> implements Response<T> {
	...
	public MessageResponse(ResponseCode responseCode) {
		this.code = responseCode.getValue();
		this.message = responseCode.getDesc();
	}

	public MessageResponse(ResponseCode responseCode, String message) {
		this.code = responseCode.getValue();
	...
	public MessageResponse(T module) {
		this.module = module;
		if (module != null) {
	...
	public MessageResponse(T module, Long totalCount) {
		this.module = module;
		this.code = ResponseCode.REQUEST_SUCCESS.getValue();
		this.message = ResponseCode.REQUEST_SUCCESS.getDesc();
