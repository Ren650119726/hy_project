...
public class FilterFactory {
	...
	public static Filter createFilter(FilterDescBean bean) throws MessageException{
	...
	private static void setField(Object instance, Field fd, String value) throws MessageException {
		try {
