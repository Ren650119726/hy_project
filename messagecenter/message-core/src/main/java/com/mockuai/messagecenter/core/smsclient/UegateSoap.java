package com.mockuai.messagecenter.core.smsclient;
 /**
...
public class UegateSoap {
	...
	//短信提交
	public String Submit(String spID,String password,String accessCode,String content,String mobileString) throws MessageException{
		String result="";
		try {
			...
			e.printStackTrace();
			throw new MessageException(ResponseCode.SYS_E_SERVICE_EXCEPTION,"发送短信接口有误，请排查外部接口是否正常");
		}
