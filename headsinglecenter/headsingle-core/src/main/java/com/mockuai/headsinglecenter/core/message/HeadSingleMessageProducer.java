...
@Component
public class HeadSingleMessageProducer implements MessageProducer {
    private static final Logger log = LoggerFactory.getLogger(HeadSingleMessageProducer.class);
    ...
    public void send(String topic, String tag, String key, Object obj) {
        try {
            Message msg = new Message(topic, tag, key, JSONObject.toJSONString(obj).getBytes("UTF-8"));
