...
@Service
public class UnlockStoreSkuStockAction extends TransAction {
    private static final Logger log = LoggerFactory
            .getLogger(UnlockStoreSkuStockAction.class);
    ...
    protected SupplierResponse doTransaction(RequestContext context)
        ...
        try {
            supplierOrderStockManager
                    .unlockSupplierOrderNum(orderStockDTO);
            log.info(" unlockSupplierOrderNum success, Exit Action [{}]", getName());
    ...
    public String getName() {
        ...
        return ActionEnum.UNLOCK_STORESKUSTOCK.getActionName();
    }
