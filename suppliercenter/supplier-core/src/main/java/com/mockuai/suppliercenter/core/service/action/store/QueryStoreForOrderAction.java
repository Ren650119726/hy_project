...
@Service
public class QueryStoreForOrderAction implements Action {
...
//                    "bizCode is null");
        ...
        try {
            List<StoreDTO> stores = storeManager.queryStoreForOrder(storeQTO, appKey);
    ...
    public String getName() {
        ...
        return ActionEnum.QUERY_STOREFORORDER.getActionName();
    }
}
