...
@Service
public class ForbiddenStoreAction extends TransAction {

    private static final Logger log = LoggerFactory
            .getLogger(ForbiddenStoreAction.class);
    @Resource
...
//                    "bizCode is null");
        ...
        if (storeDTO == null) {
            log.error("storeDTO is null when Forbidden Store , bizCode = {}", bizCode);
            return new SupplierResponse(ResponseCode.P_PARAM_NULL,
                    "storeDTO is null");
        }
        ...
        try {
            storeManager.forbiddenStore(storeDTO, appKey);

            log.info(" forbidden Store success,Exit Action [{}]", getName());
    ...
    public String getName() {
        ...
        return ActionEnum.FORBIDDEN_STORE.getActionName();
    }
