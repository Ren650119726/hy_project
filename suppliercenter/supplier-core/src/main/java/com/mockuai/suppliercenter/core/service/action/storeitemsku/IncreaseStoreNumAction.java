...
@Service
public class IncreaseStoreNumAction extends TransAction {
    private static final Logger log = LoggerFactory.getLogger(IncreaseStoreNumAction.class);
...
//                    "bizCode is null");
        ...
        try {
            storeItemSkuManager.increaseStoreNum(storeItemSkuDTO);
    ...
    public String getName() {
        ...
        return ActionEnum.INCREASE_STORENUM.getActionName();
    }
}
