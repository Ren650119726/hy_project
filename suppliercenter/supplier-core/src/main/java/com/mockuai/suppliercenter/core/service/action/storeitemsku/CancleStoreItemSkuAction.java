...
@Service
public class CancleStoreItemSkuAction extends TransAction {
    private static final Logger log = LoggerFactory
            .getLogger(CancleStoreItemSkuAction.class);
...
//                    "bizCode is null");
        ...
        try {
            storeItemSkuManager.cancleStoreItemSku(storeItemSkuDTO, appKey);
    ...
    public String getName() {
        ...
        return ActionEnum.CANCLE_STOREITEMSKU.getActionName();
    }
}
