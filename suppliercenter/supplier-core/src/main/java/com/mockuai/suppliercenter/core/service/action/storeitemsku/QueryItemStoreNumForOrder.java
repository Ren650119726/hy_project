...
@Service
public class QueryItemStoreNumForOrder implements Action {
    private static final Logger log = LoggerFactory.getLogger(QueryItemStoreNumForOrder.class);
...
//                    "bizCode is null");
        ...
        try {
            ...
            List<StoreItemSkuDTO> stores = storeItemSkuManager
                    .queryItemStoreNumForOrder(storeItemSkuQTO);
    ...
    public String getName() {
        ...
        return ActionEnum.QUERY_ITEMSTORENUMFORORDER.getActionName();
    }
}
