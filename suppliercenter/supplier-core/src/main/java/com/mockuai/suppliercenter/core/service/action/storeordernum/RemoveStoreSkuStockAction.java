...
@Service
public class RemoveStoreSkuStockAction extends TransAction {
    private static final Logger log = LoggerFactory
            .getLogger(RemoveStoreSkuStockAction.class);
    ...
    protected SupplierResponse doTransaction(RequestContext context)
        ...
        try {
            supplierOrderStockManager
                    .removeStoreSkuStock(orderStockDTO, appKey);
            log.info(" RemoveStoreSkuStock success, Exit Action [{}]",
                    getName());
    ...
    public String getName() {
        ...
        return ActionEnum.REMOVE_STORESKUSTOCK.getActionName();
    }
}
