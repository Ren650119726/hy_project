 ...
 */
@Service
public class GetShopByUserIdAction implements Action{
    private static final Logger log = LoggerFactory.getLogger(GetShopByUserIdAction.class);
    ...
    public DistributionResponse execute(RequestContext context) throws DistributionException {
        ...
        DistShopDTO distShopDTO = shopManager.getBySellerId(sellerDTO.getId());
    ...
    public String getName() {
        return ActionEnum.GET_SHOP_BY_USER_ID.getActionName();
    }
}
