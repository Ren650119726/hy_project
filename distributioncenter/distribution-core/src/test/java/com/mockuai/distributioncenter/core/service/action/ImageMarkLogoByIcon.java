...
public class ImageMarkLogoByIcon {
    ...
    public static void main(String[] args) {
        ...
        String iconPath = "d:/test/qrcode.png";
        String targerPath = "d:/test/qr1.jpg";
        String targerPath2 = "d:/test/qr2.jpg";
        // 给图片添加水印
    ...
    public static void markImageByIcon(String iconPath, InputStream inputStream,
