...
public class ImageMarkLogoByText {
    ...
    public static void main(String[] args) {
        String srcImgPath = "d:/test/bg.png";
        String logoText = "[ 测试文字水印 冠生的图片 ]";
        String targerPath = "d:/test/test1.jpg";
        String targerPath2 = "d:/test/test2.jpg";
    ...
    public static void markByText(String logoText,  InputStream is,OutputStream os,
                                           Integer degree){
        // 主图片的路径
        try {
